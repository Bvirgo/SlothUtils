...
namespace SlothUtils.Pool
{
    ...
    public class SlothPool : MonoBehaviour, ISerializationCallbackReceiver
    {
        [System.Serializable]
        public class Delay
        {
        ...
        public static List<SlothPool> Instances = new List<SlothPool>();
        ...
        public static bool TryFindPoolByPrefab(GameObject prefab, ref SlothPool foundPool)
        {
        ...
        public static bool TryFindPoolByClone(GameObject clone, ref SlothPool pool)
        {
            for (var i = Instances.Count - 1; i >= 0; i--)
            {
                pool = Instances[i];
