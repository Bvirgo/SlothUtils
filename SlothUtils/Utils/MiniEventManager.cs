...
namespace SlothUtils
{
	...
	{
	    private static Dictionary<Type, List<MiniEventListenerBase>> _subscribersList;

		static MiniEventManager()
	    {
	        _subscribersList = new Dictionary<Type, List<MiniEventListenerBase>>();
	    }
	    ...
	    public static void TriggerEvent<MiniEvent>( MiniEvent _newEvent ) where MiniEvent : struct
	    {
	        List<MiniEventListenerBase> list;
	        if( !_subscribersList.TryGetValue( typeof( MiniEvent ), out list ) )
	    ...
	    private static bool SubscriptionExists( Type _type, MiniEventListenerBase _receiver )
	    {
	        List<MiniEventListenerBase> receivers;

	        if( !_subscribersList.TryGetValue( _type, out receivers ) ) return false;
	...
	/// </summary>
	public interface MiniEventListenerBase { };
